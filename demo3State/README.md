...
```
- [Optional] Update the `appsettings.json` file under `SimpleBot_demo/demo3State` with your botFileSecret.  For Azure Bot Service bots, you can find the botFileSecret under application settings.
# Prerequisites
## Visual Studio
- Navigate to the samples folder (`SimpleBot_demo/demo3State`) and open EchoBotWithCounter.csproj in Visual Studio.
- Run the project (press `F5` key).

## Visual Studio Code
- Open `SimpleBot_demo/demo3State` sample folder.
- Bring up a terminal, navigate to `SimpleBot_demo/demo3State` folder.
- Type `dotnet run`.
